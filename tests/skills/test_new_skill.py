"""
Automated validation test for new-skill.
"""
...
SKILL_PATH = os.path.join(REPO_ROOT, "skills", "engineering", "new-skill", "SKILL.md")
DOC_PATH = os.path.join(REPO_ROOT, "docs", "engineering", "new-skill.md")
