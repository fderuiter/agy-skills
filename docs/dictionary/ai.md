...
permalink: /dictionary/ai/
category: dictionary
keywords: ["ai coding", "dictionary", "ai"]
---

# AI

A moving label, not a technology. "AI" doesn't name a fixed thing the way [model](https://fderuiter.github.io/agy-skills/dictionary/model) or [token](https://fderuiter.github.io/agy-skills/dictionary/token) does, it points at whatever computers can newly, impressively do. Right now it points at large language models. It has pointed at very different things before:
