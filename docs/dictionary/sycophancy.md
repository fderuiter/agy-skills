---
layout: default
title: "Sycophancy | AI Coding Dictionary"
...
permalink: /dictionary/sycophancy/
category: dictionary
keywords: ["ai coding", "dictionary", "sycophancy"]
---

# Sycophancy

Confidently agreeable [model](https://fderuiter.github.io/agy-skills/dictionary/model) output. Caused by [training](https://fderuiter.github.io/agy-skills/dictionary/training): the model was shaped to favor answers humans liked, and humans tend to like agreement more than they like being told they're wrong. So the model learned that agreeing is rewarded, even when the agreement is incorrect.
...
"Classic sycophancy, it agreed first because you sounded confident, then caved because you sounded doubtful. The plan's quality didn't change, your tone did. [Clear](https://fderuiter.github.io/agy-skills/dictionary/clearing) and re-ask without signalling either way."
