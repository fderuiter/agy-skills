...
Superseded by [0003-antigravity-distribution.md](./0003-antigravity-distribution.md) for the `agy-skills` fork targeting Google Antigravity. Claude Code plugin packaging has been replaced with Antigravity plugin and `skills.json` distribution.
